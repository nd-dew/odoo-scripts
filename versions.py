...
VERSIONS= [
    Version(formal="15.0",      short="15",    ip="127.0.1.150", tags={"150"}),
    Version(formal="16.0",      short="16",    ip="127.0.1.160", tags={"160"}),
    Version(formal="17.0",      short="17",    ip="127.0.1.170", tags={"170"}),
    Version(formal="saas-17.2", short="17.2",  ip="127.0.1.172", tags={"172"}),
    Version(formal="saas-17.4", short="17.4",  ip="127.0.1.174", tags={"174"}),
    Version(formal="18.0",      short="18",    ip="127.0.1.180", tags={"18"}),
    Version(formal="saas-18.1", short="18.1",  ip="127.0.1.181", tags={"181"}),
    Version(formal="saas-18.2", short="18.2",  ip="127.0.1.182", tags={"182"}),
    Version(formal="master",    short="master",ip="127.0.1.254", tags={"ms"}),
]
